...
const IntroSection = () => {
  ...
  return (
    <section className="">
      ...
      <div
        className={cn(
          "relative mb-8 mt-4 flex min-h-[10vh] items-center justify-between px-8 lg:mt-0 lg:min-h-[35vh] lg:px-12 xl:px-8 2xl:gap-x-0 container m-auto",
          isActive
      ...
      {/* Intro heading div */}
      <div className="flex w-full flex-col items-center justify-center bg-popover p-4 py-8 mt-10">
        <h1 className=" mb-6 px-4 text-center text-2xl font-bold sm:px-6 lg:px-12 lg:text-3xl xl:px-2 2xl:px-0">
